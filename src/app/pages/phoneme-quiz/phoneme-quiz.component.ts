...
export class PhonemeQuizComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(
        ...
        if (this.quizAll === 'true') {
            ...
            this.puzzleimg = '../../assets/img/puzzle-pieces/puzzle-'+ this.phoneme.id.replace(/-begin|-end/g,'') +'/puzzle-' + this.phoneme.id.replace(/-begin|-end/g,'') + '-composite.png';
        ...
        this.puzzleDirectory = '../../assets/img/puzzle-pieces/puzzle-' + this.phoneme.id.replace(/-begin|-end/g,'');
        ...
        for (let i = 0; i <= 3; i++) {
            for (let j = 0; j <= 2; j++) {
                this.puzzlePieceImages.push(
                    this.puzzleDirectory + '/puzzle-' + this.phoneme.id.replace(/-begin|-end/g,'') + '-row' + i + '-col' + j + '.png'
                );
            }
        }
